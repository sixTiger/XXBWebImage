...
#ifdef __OBJC_GC__
#error XXBWebImage does not support Objective-C Garbage Collection
#endif
...
extern UIImage *XXBScaledImageForKey(NSString *key, UIImage *image);

typedef void(^XXBWebImageNoParamsBlock)();

extern NSString *const XXBWebImageErrorDomain;
